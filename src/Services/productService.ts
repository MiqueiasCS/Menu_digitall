import { Between, getRepository, LessThanOrEqual, MoreThan, MoreThanOrEqual } from "typeorm";
...
export const updateProductStatusService = async (id: string, status: boolean, isAdm: boolean) => {
  const productRepository = getRepository(Product)
