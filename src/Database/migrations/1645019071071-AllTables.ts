...
export class AllTables1645019071071 implements MigrationInterface {
    name = 'AllTables1645019071071'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "orders_dispatcheds" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "note" character varying NOT NULL, "processed" boolean NOT NULL DEFAULT false, "orderId" uuid, CONSTRAINT "PK_580ab2a3e4be9968a2189f99d42" PRIMARY KEY ("id"))`);
