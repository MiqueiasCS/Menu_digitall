...
export class entities1645194398964 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "orders_products" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "product_quantity" integer NOT NULL, "productId" uuid, "orderId" uuid, CONSTRAINT "PK_4945c6758fd65ffacda760b4ac9" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "orders_dispatched" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "note" character varying NOT NULL, "tableidentifier" character varying NOT NULL, "processed" boolean NOT NULL DEFAULT false, "orderId" uuid, CONSTRAINT "PK_b5915925e54182d30b7910d8a0a" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "table" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tableidentifier" character varying NOT NULL, CONSTRAINT "UQ_01f317097c1b15fa21ed5e710d0" UNIQUE ("tableidentifier"), CONSTRAINT "PK_28914b55c485fc2d7a101b1b2a4" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "orders" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "order_date" TIMESTAMP NOT NULL DEFAULT now(), "client" character varying NOT NULL, "tableId" uuid, CONSTRAINT "PK_710e2d4957aa5878dfe94e4ac2f" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "orders_dispatched" ADD CONSTRAINT "FK_958457d9434d93e471f23c8ed26" FOREIGN KEY ("orderId") REFERENCES "orders"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "orders" ADD CONSTRAINT "FK_2a7fdd7af437285a3ef0fc8b64f" FOREIGN KEY ("tableId") REFERENCES "table"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "bills" ADD CONSTRAINT "FK_8b07afbe724f329c2a65c387c31" FOREIGN KEY ("orderId") REFERENCES "orders"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "bills" DROP CONSTRAINT "FK_8b07afbe724f329c2a65c387c31"`
    );
    await queryRunner.query(
      `ALTER TABLE "orders" DROP CONSTRAINT "FK_2a7fdd7af437285a3ef0fc8b64f"`
    );
    await queryRunner.query(
      `ALTER TABLE "orders_dispatched" DROP CONSTRAINT "FK_958457d9434d93e471f23c8ed26"`
    );
    await queryRunner.query(
